...
function quick_partition (start, end)
{
    ...
    div_update(divs[start],div_sizes[start],"#f0ad4e");//Color update
        ...
        for(var j =start + 1; j <= end ; j++ )
        {
            ...
            if (div_sizes[ j ] < piv)
            {
                ...
                div_update(divs[i],div_sizes[i],"#0275d8");//Height update
                div_update(divs[j],div_sizes[j],"#0275d8");//Height update

                i += 1;
            }
    }
    div_update(divs[start],div_sizes[start],"#d9534f");//Color update
    ...
    div_update(divs[start],div_sizes[start],"#d9534f");//Height update
